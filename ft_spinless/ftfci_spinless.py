...
def kernel_ft_smpl(h1e, g2e, norb, nelec, T, vecgen=0, m=50,\
...
#    rdma, rdmb = flan.ht_rdm1s(qud, hop, vecgen, T, norb, m, nsamp)
    dm1, dm2 = ftsmpl.ft_ismpl_rdm12s(qud,\
...
#   exit()
    ...
    for i in range(norb):
        eri[i,i,i,i] = u
#    _e =kernel_ft_smpl(h1e, eri, norb, nelec, T, m=40, nsmpl=1000) 
#    print (_e/norb).real

#    dm1a, dm1b = rdm1s_ft_smpl(h1e, eri, norb, nelec, T, vecgen=0, m=20, nsmpl=10)
    dm1, dm2 = rdm12s_ft_smpl(h1e, eri, norb, nelec, T, vecgen=0, m=20, nsamp=10)
    print dm1 
